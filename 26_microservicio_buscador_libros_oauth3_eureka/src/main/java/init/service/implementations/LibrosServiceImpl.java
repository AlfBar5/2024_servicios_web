...
public class LibrosServiceImpl implements LibrosService {
	...
	-alta de formaciones (en la base de datos del 02_servicio_crud_cursos)
		...
		//RestClient para acceder al servicio web. Tenemos que usar dos RestClient porque llamamos a Eureka y Key
		//para acceder a uno u otro les damos nombres diferentes y los usamos donde correspoda
		@Autowired
