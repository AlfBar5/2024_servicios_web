...
-Actualización de precios. Se recibe la denominación y porcentaje, y se suben en ese porcentaje los precios de todos los cursos de esa denominación 
	...
	//url para llamarlo --> http://localhost:8080/cursos
	...
	//url para llamarlo --> http://localhost:8080/curso/curso?idCurso=2
	...
	//url para llamarlo --> http://localhost:8080/cursos/cursos/1/999
